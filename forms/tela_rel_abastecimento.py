...
# Form implementation generated from reading ui file 'tela_rel_abastecimento.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.combo_Meses.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.line_Ano.setMinimumSize(QtCore.QSize(70, 0))
        ...
        self.combo_Veiculo = QtWidgets.QComboBox(self.widget_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.combo_Veiculo.setMaximumSize(QtCore.QSize(250, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.horizontalLayout_3.addWidget(self.combo_Veiculo)
        ...
        self.combo_Combustivel = QtWidgets.QComboBox(self.widget_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.combo_Combustivel.setMinimumSize(QtCore.QSize(100, 0))
        self.combo_Combustivel.setMaximumSize(QtCore.QSize(250, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.combo_Combustivel.addItem("")
        self.combo_Combustivel.addItem("")
        self.horizontalLayout_3.addWidget(self.combo_Combustivel)
        ...
        self.combo_Classifica.setMinimumSize(QtCore.QSize(100, 0))
        ...
        self.label_medio_por_lt = QtWidgets.QLabel(self.widget_2)
        self.label_medio_por_lt.setGeometry(QtCore.QRect(160, 20, 100, 25))
        self.label_medio_por_lt.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_medio_por_lt.setFont(font)
        self.label_medio_por_lt.setText("")
        self.label_medio_por_lt.setAlignment(QtCore.Qt.AlignCenter)
        self.label_medio_por_lt.setObjectName("label_medio_por_lt")
        self.label_20 = QtWidgets.QLabel(self.widget_2)
        self.label_20.setGeometry(QtCore.QRect(14, 20, 141, 25))
        ...
        self.label_23.setGeometry(QtCore.QRect(14, 50, 141, 25))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_total_km_rodados = QtWidgets.QLabel(self.widget_2)
        self.label_total_km_rodados.setGeometry(QtCore.QRect(160, 50, 100, 25))
        self.label_total_km_rodados.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_total_km_rodados.setFont(font)
        self.label_total_km_rodados.setText("")
        self.label_total_km_rodados.setAlignment(QtCore.Qt.AlignCenter)
        self.label_total_km_rodados.setObjectName("label_total_km_rodados")
        self.label_total_km_lt = QtWidgets.QLabel(self.widget_2)
        self.label_total_km_lt.setGeometry(QtCore.QRect(166, 80, 100, 25))
        self.label_total_km_lt.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_total_km_lt.setFont(font)
        self.label_total_km_lt.setText("")
        self.label_total_km_lt.setAlignment(QtCore.Qt.AlignCenter)
        self.label_total_km_lt.setObjectName("label_total_km_lt")
        self.label_24 = QtWidgets.QLabel(self.widget_2)
        self.label_24.setGeometry(QtCore.QRect(20, 80, 141, 25))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_25.setGeometry(QtCore.QRect(344, 20, 141, 25))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_total_custo_km = QtWidgets.QLabel(self.widget_2)
        self.label_total_custo_km.setGeometry(QtCore.QRect(490, 20, 100, 25))
        self.label_total_custo_km.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_total_custo_km.setFont(font)
        self.label_total_custo_km.setText("")
        self.label_total_custo_km.setAlignment(QtCore.Qt.AlignCenter)
        self.label_total_custo_km.setObjectName("label_total_custo_km")
        self.label_total_litros = QtWidgets.QLabel(self.widget_2)
        self.label_total_litros.setGeometry(QtCore.QRect(466, 70, 100, 25))
        self.label_total_litros.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_total_litros.setFont(font)
        self.label_total_litros.setText("")
        self.label_total_litros.setAlignment(QtCore.Qt.AlignCenter)
        self.label_total_litros.setObjectName("label_total_litros")
        self.label_26 = QtWidgets.QLabel(self.widget_2)
        self.label_26.setGeometry(QtCore.QRect(320, 70, 141, 25))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.label_Valor_Total = QtWidgets.QLabel(self.widget)
        self.label_Valor_Total.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout.addWidget(self.label_Valor_Total)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Abastecimento Mensal/Anual"))
        ...
        self.label_19.setText(_translate("MainWindow", "Veículo:"))
        self.label_22.setText(_translate("MainWindow", "Combustível:"))
        ...
        self.label_5.setText(_translate("MainWindow", "Abastecimento"))
        ...
        item.setText(_translate("MainWindow", "Km rodados"))
        item = self.table_Lista.horizontalHeaderItem(10)
        item.setText(_translate("MainWindow", "km/Lt"))
        item = self.table_Lista.horizontalHeaderItem(11)
        item.setText(_translate("MainWindow", "Custo por km"))
        self.label_20.setText(_translate("MainWindow", "Preço médio por litro:"))
        self.label_23.setText(_translate("MainWindow", "total km rodados:"))
        self.label_24.setText(_translate("MainWindow", "km/L:"))
        self.label_25.setText(_translate("MainWindow", "Custo por km:"))
        self.label_26.setText(_translate("MainWindow", "Litros Total:"))
