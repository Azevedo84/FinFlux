...
# Form implementation generated from reading ui file 'tela_pag_cartao.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_8.setMaximumSize(QtCore.QSize(16777215, 300))
        ...
        self.verticalLayout_4.setContentsMargins(2, 6, 2, 6)
        ...
        self.horizontalLayout_5.setContentsMargins(15, 3, 15, 3)
        ...
        self.combo_Banco = QtWidgets.QComboBox(self.widget_10)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_5.addWidget(self.combo_Banco)
        ...
        self.horizontalLayout_6.setContentsMargins(15, 3, 15, 3)
        ...
        self.combo_Estab = QtWidgets.QComboBox(self.widget_11)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_6.addWidget(self.combo_Estab)
        ...
        self.horizontalLayout_7.setContentsMargins(15, 3, 15, 3)
        ...
        self.combo_Fatura = QtWidgets.QComboBox(self.widget_12)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_7.addWidget(self.combo_Fatura)
        ...
        self.horizontalLayout_8.setContentsMargins(15, 3, 15, 3)
        ...
        self.label_Saldo = QtWidgets.QLabel(self.widget_13)
        ...
        self.horizontalLayout_8.addWidget(self.label_Saldo)
        ...
        self.horizontalLayout_9.setContentsMargins(15, 3, 15, 3)
        ...
        self.line_Valor = QtWidgets.QLineEdit(self.widget_14)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_10.setContentsMargins(15, 3, 15, 3)
        ...
        self.plain_Obs = QtWidgets.QPlainTextEdit(self.widget_15)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.combo_Consulta_Banco.setMinimumSize(QtCore.QSize(0, 25))
        self.combo_Consulta_Banco.setMaximumSize(QtCore.QSize(16777215, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.combo_Consulta_Fatura.setMinimumSize(QtCore.QSize(0, 23))
        self.combo_Consulta_Fatura.setMaximumSize(QtCore.QSize(16777215, 23))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.btn_Consultar.setMinimumSize(QtCore.QSize(90, 25))
        self.btn_Consultar.setMaximumSize(QtCore.QSize(90, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.horizontalLayout_3.addWidget(self.btn_Consultar)
        ...
        self.line_Valor_Final = QtWidgets.QLineEdit(self.widget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.line_Valor_Final.sizePolicy().hasHeightForWidth())
        self.line_Valor_Final.setSizePolicy(sizePolicy)
        self.line_Valor_Final.setMinimumSize(QtCore.QSize(80, 23))
        self.line_Valor_Final.setMaximumSize(QtCore.QSize(80, 23))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.line_Valor_Final.setFont(font)
        self.line_Valor_Final.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_Valor_Final.setText("")
        self.line_Valor_Final.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.line_Valor_Final.setObjectName("line_Valor_Final")
        self.horizontalLayout_4.addWidget(self.line_Valor_Final)
        ...
        self.date_Vencimento = QtWidgets.QDateEdit(self.widget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_4.addWidget(self.date_Vencimento)
        ...
        self.table_Lista = QtWidgets.QTableWidget(self.widget_7)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Pagamento de Cartão de Crédito"))
        self.label_4.setText(_translate("MainWindow", "Código:"))
        self.label_titulo.setText(_translate("MainWindow", "Pagamento Cartão de Crédito"))
        ...
        self.label_19.setText(_translate("MainWindow", "Valor Final:"))
        self.label_20.setText(_translate("MainWindow", "Vencimento:"))
        self.label_5.setText(_translate("MainWindow", "Despesas Fatura"))
        ...
        item.setText(_translate("MainWindow", "SAIDA"))
