...
# Form implementation generated from reading ui file 'tela_rel_mercado.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.combo_Grupo.setMaximumSize(QtCore.QSize(250, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.combo_Produtos = QtWidgets.QComboBox(self.widget_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combo_Produtos.sizePolicy().hasHeightForWidth())
        self.combo_Produtos.setSizePolicy(sizePolicy)
        self.combo_Produtos.setMinimumSize(QtCore.QSize(180, 0))
        self.combo_Produtos.setMaximumSize(QtCore.QSize(250, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        self.combo_Produtos.setFont(font)
        self.combo_Produtos.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.combo_Produtos.setObjectName("combo_Produtos")
        self.combo_Produtos.addItem("")
        self.combo_Produtos.setItemText(0, "")
        self.horizontalLayout_3.addWidget(self.combo_Produtos)
        ...
        self.label_Qtde_Total = QtWidgets.QLabel(self.widget)
        self.label_Qtde_Total.setMinimumSize(QtCore.QSize(70, 0))
        self.label_Qtde_Total.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_Qtde_Total.setFont(font)
        self.label_Qtde_Total.setText("")
        self.label_Qtde_Total.setAlignment(QtCore.Qt.AlignCenter)
        self.label_Qtde_Total.setObjectName("label_Qtde_Total")
        self.horizontalLayout.addWidget(self.label_Qtde_Total)
        ...
        self.label_RS_Total = QtWidgets.QLabel(self.widget)
        self.label_RS_Total.setMinimumSize(QtCore.QSize(70, 0))
        self.label_RS_Total.setMaximumSize(QtCore.QSize(100, 25))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.label_RS_Total.setFont(font)
        self.label_RS_Total.setText("")
        self.label_RS_Total.setAlignment(QtCore.Qt.AlignCenter)
        self.label_RS_Total.setObjectName("label_RS_Total")
        self.horizontalLayout.addWidget(self.label_RS_Total)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Mercado Mensal/Anual"))
        ...
        self.label_22.setText(_translate("MainWindow", "Produtos:"))
        ...
        self.combo_Classifica.setItemText(3, _translate("MainWindow", "MAIOR UNIT"))
        self.combo_Classifica.setItemText(4, _translate("MainWindow", "MENOR UNIT"))
        self.combo_Classifica.setItemText(5, _translate("MainWindow", "GRUPO"))
        self.combo_Classifica.setItemText(6, _translate("MainWindow", "PRODUTO"))
        self.combo_Classifica.setItemText(7, _translate("MainWindow", "ESTABELECIMENTO"))
        self.btn_Consulta.setText(_translate("MainWindow", "Consultar"))
        self.label_5.setText(_translate("MainWindow", "Compras de Mercado"))
        ...
        self.label_23.setText(_translate("MainWindow", "Qtde Total:"))
        self.label_18.setText(_translate("MainWindow", "R$ Total:"))
