...
# Form implementation generated from reading ui file 'tela_mov_transf.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_Saldo1 = QtWidgets.QLabel(self.widget_8)
        self.label_Saldo1.setMinimumSize(QtCore.QSize(0, 23))
        self.label_Saldo1.setMaximumSize(QtCore.QSize(16777215, 23))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_Saldo1.setFont(font)
        self.label_Saldo1.setText("")
        self.label_Saldo1.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_Saldo1.setObjectName("label_Saldo1")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.label_Saldo1)
        ...
        self.widget_9.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.label_titulo_3 = QtWidgets.QLabel(self.widget_9)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.label_titulo_3)
        ...
        self.combo_Tipo_2 = QtWidgets.QComboBox(self.widget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combo_Tipo_2.sizePolicy().hasHeightForWidth())
        self.combo_Tipo_2.setSizePolicy(sizePolicy)
        self.combo_Tipo_2.setMinimumSize(QtCore.QSize(0, 23))
        self.combo_Tipo_2.setMaximumSize(QtCore.QSize(16777215, 23))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.combo_Tipo_2.setFont(font)
        self.combo_Tipo_2.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.combo_Tipo_2.setObjectName("combo_Tipo_2")
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.combo_Tipo_2)
        ...
        self.formLayout_2.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.plain_Obs)
        ...
        self.label_Saldo2 = QtWidgets.QLabel(self.widget_9)
        self.label_Saldo2.setMinimumSize(QtCore.QSize(0, 23))
        self.label_Saldo2.setMaximumSize(QtCore.QSize(16777215, 23))
        font = QtGui.QFont()
        font.setPointSize(9)
        self.label_Saldo2.setFont(font)
        self.label_Saldo2.setText("")
        self.label_Saldo2.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_Saldo2.setObjectName("label_Saldo2")
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.label_Saldo2)
        self.combo_Banco_2 = QtWidgets.QComboBox(self.widget_9)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.combo_Banco_2.sizePolicy().hasHeightForWidth())
        self.combo_Banco_2.setSizePolicy(sizePolicy)
        self.combo_Banco_2.setMinimumSize(QtCore.QSize(0, 23))
        self.combo_Banco_2.setMaximumSize(QtCore.QSize(16777215, 23))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.combo_Banco_2.setFont(font)
        self.combo_Banco_2.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.combo_Banco_2.setObjectName("combo_Banco_2")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.combo_Banco_2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Movimentação de Transferência"))
        self.label_4.setText(_translate("MainWindow", "Código:"))
        self.label_titulo.setText(_translate("MainWindow", "Movimentação de Transferência Entre Contas"))
        ...
        self.label_titulo_2.setText(_translate("MainWindow", "Origem"))
        ...
        self.label_titulo_3.setText(_translate("MainWindow", "Destino"))
        self.label_17.setText(_translate("MainWindow", "Banco:"))
        self.label_18.setText(_translate("MainWindow", "Tipo Conta:"))
        self.label_29.setText(_translate("MainWindow", "Observação:"))
        self.label_19.setText(_translate("MainWindow", "Saldo:"))
        self.label_5.setText(_translate("MainWindow", "Lista das Últimas Movimentações"))
        self.label_9.setText(_translate("MainWindow", "Banco:"))
        ...
        item.setText(_translate("MainWindow", "ENT"))
        item = self.table_Lista.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "SAI"))
