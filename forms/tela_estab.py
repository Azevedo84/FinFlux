...
# Form implementation generated from reading ui file 'tela_estab.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line_Telefone = QtWidgets.QLineEdit(self.widget_5)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.line_Telefone.setFont(font)
        self.line_Telefone.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_Telefone.setText("")
        self.line_Telefone.setMaxLength(20)
        self.line_Telefone.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.line_Telefone.setObjectName("line_Telefone")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.line_Telefone)
        ...
        self.line_Email = QtWidgets.QLineEdit(self.widget_5)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.line_Email.setFont(font)
        self.line_Email.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_Email.setText("")
        self.line_Email.setMaxLength(20)
        self.line_Email.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        ...
        self.line_Site = QtWidgets.QLineEdit(self.widget_5)
        font = QtGui.QFont()
        font.setPointSize(8)
        self.line_Site.setFont(font)
        self.line_Site.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.line_Site.setText("")
        self.line_Site.setMaxLength(20)
        self.line_Site.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.line_Site.setObjectName("line_Site")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.line_Site)
        ...
        self.line_Consulta.setMinimumSize(QtCore.QSize(300, 25))
        self.line_Consulta.setMaximumSize(QtCore.QSize(300, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Cadastro de Estabelecimentos"))
        self.label_4.setText(_translate("MainWindow", "Código:"))
        self.label_titulo.setText(_translate("MainWindow", "Cadastro de Estabelecimentos"))
        ...
        self.label_25.setText(_translate("MainWindow", "Telefone:"))
        self.label_26.setText(_translate("MainWindow", "E-mail:"))
        self.label_27.setText(_translate("MainWindow", "Site:"))
        ...
        self.label_5.setText(_translate("MainWindow", "Lista de Estabelecimentos"))
