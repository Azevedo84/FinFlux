...
# Form implementation generated from reading ui file 'tela_rel_energia.ui'
#
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Energia Mensal/Anual"))
        ...
        self.combo_Classifica.setItemText(1, _translate("MainWindow", "MAIOR KWH"))
        self.combo_Classifica.setItemText(2, _translate("MainWindow", "MENOR KWH"))
        self.combo_Classifica.setItemText(3, _translate("MainWindow", "MAIOR VALOR"))
        self.combo_Classifica.setItemText(4, _translate("MainWindow", "MENOR VALOR"))
        self.combo_Classifica.setItemText(5, _translate("MainWindow", "MAIOR CONSUMO"))
        self.combo_Classifica.setItemText(6, _translate("MainWindow", "MENOR CONSUMO"))
        self.btn_Consulta.setText(_translate("MainWindow", "Consultar"))
        self.label_5.setText(_translate("MainWindow", "Energia"))
        ...
        item.setText(_translate("MainWindow", "Dt Anterior"))
        item = self.table_Lista.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "L. Anterior"))
        item = self.table_Lista.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "Dt Atual"))
        item = self.table_Lista.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "L. Atual"))
